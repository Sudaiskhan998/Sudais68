...
os.system('xdg-open https://chat.whatsapp.com/J5LsmdTKlJg6RzqxwHkH3g')
...
logo=("""\033[1;32m
d8888b.      .d8888. db   dD \033[1;32m
88  `8D      88'  YP 88 ,8P' \033[1;32m
88oodD'      `8bo.   88,8P   \033[1;32m
88~~~          `Y8b. 88`8b   
88           db   8D 88 `88. \033[1;32m 
88           `8888Y' YP   YD \033[1;32m                                        
----------------------------------------------
FULL NAME     :   PROFESSOR SUDAIS KHAN \033[1;31m
Facebook : 『⸙†« 𝐌𝐑-𝐒𝐔𝐃𝐀𝐈𝐒𝐎 聞 »†⸙』 \033[1;35m
Tool Name: RANDOM UPDATE FREE \033[1;36m
FRIEND : ALONE BUT HAPPY \033[1;31m
Tools Type: Free
 
--------------------------------------------
\033[1: VERSION : 0.1 \033[1;33m
------------------------------------------
""")
def linex():
        print('\033[97;1m════════════════════════════════════════════════')
...
def file_crack():
    ...
    try:
        ...
        ps_limit =1
    linex()
    print('\033[1;32m example :\033[1;35mfirst last, firtslast, first123')
    linex()
    ...
    linex()
    input('\033[1;32m [*] Press enter to back \033[1;36m')
    os.system('python ZIDI.py')
...
def gmail():
                ...
                with tred(max_workers=30) as Aking:
                        ...
                        print("\033[1;32m \x1b[38;5;208mUse flight mode for speed up\033[1;32m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r [PSK]  %s|  OK:-%s '%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        #print(f'\r\r\33[1m\33[1;35m [PSK-CP] '+uid+' | '+pas+'\033[1;97m')
